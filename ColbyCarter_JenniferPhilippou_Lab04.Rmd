...
plot(model1, which = 1)
plot(model1, which = 5)
#NEED TO REFORMAT PEARSON RESIDUAL PLOTS SO THE LEFT AXIS SCALES ARE MORE CLEAR--I CONTINUE TO BE TERRIBLE AT FORMATTING CHARTS IN R (CMC)
...
Model 2: increase accuracy without increasing bias
  - taxpc, control for income (sq rt?)
  - west, central (interact each with urban? not enough obs)
  - pctymle, control for demographics
  - pctmin80
